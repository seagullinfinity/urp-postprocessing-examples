	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				int VertexID5_g30 = v.ase_vertexID;
				float3 PositionLs5_g30 = float3( 0,0,0 );
				float3 NormalWs5_g30 = float3( 0,0,0 );
				float3 NormalLs5_g30 = float3( 0,0,0 );
				float3 TangentWs5_g30 = float3( 0,0,0 );
				float3 TangentLs5_g30 = float3( 0,0,0 );
				float3 CenterWs5_g30 = float3( 0,0,0 );
				float3 CenterLs5_g30 = float3( 0,0,0 );
				float4 Color5_g30 = float4( 0,0,0,0 );
				float4 EmissionHash5_g30 = float4( 0,0,0,0 );
				float Metallic5_g30 = 0.0;
				float Smoothness5_g30 = 0.0;
				float2 Tex5_g30 = float2( 0,0 );
				float4 TextureWeight5_g30 = float4( 1,0,0,0 );
				float SdfValue5_g30 = 0.0;
				float3 Outward2dNormalLs5_g30 = float3( 0,0,0 );
				float3 Outward2dNormalWs5_g30 = float3( 0,0,0 );
				float3 localMudBunSplatPoint5_g30 = MudBunSplatPoint( VertexID5_g30 , PositionLs5_g30 , NormalWs5_g30 , NormalLs5_g30 , TangentWs5_g30 , TangentLs5_g30 , CenterWs5_g30 , CenterLs5_g30 , Color5_g30 , EmissionHash5_g30 , Metallic5_g30 , Smoothness5_g30 , Tex5_g30 , TextureWeight5_g30 , SdfValue5_g30 , Outward2dNormalLs5_g30 , Outward2dNormalWs5_g30 );
				float3 temp_output_199_21 = localMudBunSplatPoint5_g30;
				
				float2 vertexToFrag34_g30 = Tex5_g30;
				o.ase_texcoord7.xy = vertexToFrag34_g30;
				float4 vertexToFrag3_g30 = Color5_g30;
				o.ase_texcoord8 = vertexToFrag3_g30;
				
				float3 vertexToFrag11_g30 = (EmissionHash5_g30).xyz;
				o.ase_texcoord9.xyz = vertexToFrag11_g30;
				
				float vertexToFrag2_g30 = Metallic5_g30;
				o.ase_texcoord7.z = vertexToFrag2_g30;
				
				float vertexToFrag14_g30 = Smoothness5_g30;
				o.ase_texcoord7.w = vertexToFrag14_g30;
				
				float3 vertexToFrag20_g30 = localMudBunSplatPoint5_g30;
				o.ase_texcoord10.xyz = vertexToFrag20_g30;
				float3 vertexToFrag27_g31 = temp_output_199_21;
				...
				#endif
				float3 vertexValue = temp_output_199_21;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
					v.vertex.xyz = vertexValue;
				#else
					v.vertex.xyz += vertexValue;
				#endif
				v.ase_normal = NormalWs5_g30;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 vertexToFrag34_g30 = IN.ase_texcoord7.xy;
				float2 clampResult36_g30 = clamp( ( vertexToFrag34_g30 + float2( 0.5,0.5 ) ) , float2( 0,0 ) , float2( 1,1 ) );
				float4 vertexToFrag3_g30 = IN.ase_texcoord8;
				float4 temp_output_7_0_g30 = ( _Color * vertexToFrag3_g30 * _IsSplatRenderMaterial );
				float4 temp_output_124_0 = ( tex2D( _MainTex, clampResult36_g30 ) * temp_output_7_0_g30 );
				
				float3 vertexToFrag11_g30 = IN.ase_texcoord9.xyz;
				
				float vertexToFrag2_g30 = IN.ase_texcoord7.z;
				
				float vertexToFrag14_g30 = IN.ase_texcoord7.w;
				
				float localComputeOpaqueTransparency20_g31 = ( 0.0 );
				float3 vertexToFrag20_g30 = IN.ase_texcoord10.xyz;
				float4 unityObjectToClipPos17_g30 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag20_g30));
				float4 computeScreenPos18_g30 = ComputeScreenPos( unityObjectToClipPos17_g30 );
				float2 ScreenPos20_g31 = (( ( computeScreenPos18_g30 / (computeScreenPos18_g30).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g31 = IN.ase_texcoord11.xyz;
				float3 VertPos20_g31 = vertexToFrag27_g31;
				int VertexID5_g30 = IN.ase_texcoord9.w;
				float3 PositionLs5_g30 = float3( 0,0,0 );
				float3 NormalWs5_g30 = float3( 0,0,0 );
				float3 NormalLs5_g30 = float3( 0,0,0 );
				float3 TangentWs5_g30 = float3( 0,0,0 );
				...
				float3 Outward2dNormalWs5_g30 = float3( 0,0,0 );
				float3 localMudBunSplatPoint5_g30 = MudBunSplatPoint( VertexID5_g30 , PositionLs5_g30 , NormalWs5_g30 , NormalLs5_g30 , TangentWs5_g30 , TangentLs5_g30 , CenterWs5_g30 , CenterLs5_g30 , Color5_g30 , EmissionHash5_g30 , Metallic5_g30 , Smoothness5_g30 , Tex5_g30 , TextureWeight5_g30 , SdfValue5_g30 , Outward2dNormalLs5_g30 , Outward2dNormalWs5_g30 );
				float Hash20_g31 = (EmissionHash5_g30).w;
				float ifLocalVar62_g30 = 0;
				UNITY_BRANCH 
				if( length( vertexToFrag34_g30 ) <= 0.5 )
				ifLocalVar62_g30 = 1.0;
				else
				ifLocalVar62_g30 = 0.0;
				#ifdef MUDBUN_QUAD_SPLATS
				float staticSwitch50_g30 = 1.0;
				#else
				float staticSwitch50_g30 = ifLocalVar62_g30;
				#endif
				float AlphaIn20_g31 = ( (temp_output_7_0_g30).a * staticSwitch50_g30 );
				...
				float3 Emission = ( vertexToFrag11_g30 * (_Emission).rgb );
				float3 Specular = 0.5;
				float Metallic = ( _Metallic * vertexToFrag2_g30 );
				float Smoothness = ( _Smoothness * vertexToFrag14_g30 );
				float Occlusion = 1;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float2 vertexToFrag34_g30 = Tex5_g30;
				o.ase_texcoord2.xy = vertexToFrag34_g30;
				float4 vertexToFrag3_g30 = Color5_g30;
				o.ase_texcoord3 = vertexToFrag3_g30;
				float3 vertexToFrag20_g30 = localMudBunSplatPoint5_g30;
				o.ase_texcoord4.xyz = vertexToFrag20_g30;
				float3 vertexToFrag27_g31 = temp_output_199_21;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 vertexToFrag34_g30 = IN.ase_texcoord2.xy;
				float2 clampResult36_g30 = clamp( ( vertexToFrag34_g30 + float2( 0.5,0.5 ) ) , float2( 0,0 ) , float2( 1,1 ) );
				float4 vertexToFrag3_g30 = IN.ase_texcoord3;
				float4 temp_output_7_0_g30 = ( _Color * vertexToFrag3_g30 * _IsSplatRenderMaterial );
				float4 temp_output_124_0 = ( tex2D( _MainTex, clampResult36_g30 ) * temp_output_7_0_g30 );
				float localComputeOpaqueTransparency20_g31 = ( 0.0 );
				float3 vertexToFrag20_g30 = IN.ase_texcoord4.xyz;
				float4 unityObjectToClipPos17_g30 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag20_g30));
				float4 computeScreenPos18_g30 = ComputeScreenPos( unityObjectToClipPos17_g30 );
				float2 ScreenPos20_g31 = (( ( computeScreenPos18_g30 / (computeScreenPos18_g30).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g31 = IN.ase_texcoord5.xyz;
				float3 VertPos20_g31 = vertexToFrag27_g31;
				int VertexID5_g30 = IN.ase_texcoord2.z;
				float3 PositionLs5_g30 = float3( 0,0,0 );
				float3 NormalWs5_g30 = float3( 0,0,0 );
				float3 NormalLs5_g30 = float3( 0,0,0 );
				float3 TangentWs5_g30 = float3( 0,0,0 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 vertexToFrag11_g30 = (EmissionHash5_g30).xyz;
				o.ase_texcoord4.xyz = vertexToFrag11_g30;
				
				float3 vertexToFrag20_g30 = localMudBunSplatPoint5_g30;
				o.ase_texcoord5.xyz = vertexToFrag20_g30;
				float3 vertexToFrag27_g31 = temp_output_199_21;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 vertexToFrag11_g30 = IN.ase_texcoord4.xyz;
				
				float localComputeOpaqueTransparency20_g31 = ( 0.0 );
				float3 vertexToFrag20_g30 = IN.ase_texcoord5.xyz;
				float4 unityObjectToClipPos17_g30 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag20_g30));
				float4 computeScreenPos18_g30 = ComputeScreenPos( unityObjectToClipPos17_g30 );
				float2 ScreenPos20_g31 = (( ( computeScreenPos18_g30 / (computeScreenPos18_g30).w ) * _ScreenParams )).xy;
...
/*ASEBEGIN
Version=18800
-1569;255;1302;771;-423.5307;642.7201;1.3;True;False
...
WireConnection;193;1;199;29
WireConnection;124;0;193;0
WireConnection;124;1;199;22
WireConnection;133;0;124;0
WireConnection;119;8;199;25
WireConnection;119;15;199;21
WireConnection;119;18;199;57
WireConnection;119;22;199;24
...
WireConnection;188;2;199;27
WireConnection;188;3;199;26
WireConnection;188;4;199;23
WireConnection;188;6;197;0
WireConnection;188;7;119;25
WireConnection;188;8;199;21
WireConnection;188;10;199;28
ASEEND*/
//CHKSM=306E106C5982D8CC257163650C559142A8E64E99