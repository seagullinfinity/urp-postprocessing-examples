...
namespace MudBun
{
  ...
  public abstract class MudRendererBase : MonoBehaviour
  {
    ...
    public struct Const
    {
      ...
      public static int VoxelTreeBranchingFactorsComrpessed;
    ...
    private static int s_voxelTreeBranchingFactorsCompressed = -1;
    public static int[] VoxelTreeBranchingFactors => s_voxelTreeBranchingFactors; 
    public static int VoxelTreeBranchingFactorsComrpessed
    {
      get
      {
        if (s_voxelTreeBranchingFactorsCompressed == -1)
          s_voxelTreeBranchingFactorsCompressed = (int) Codec.Pack8888((uint)s_voxelTreeBranchingFactors[0], (uint) s_voxelTreeBranchingFactors[1], (uint) s_voxelTreeBranchingFactors[2], 0);
        return s_voxelTreeBranchingFactorsCompressed;
      }
    }
    ...
    */
    ...
    public static void ValidateShaderConstantId()
    {
      ...
      Const.VoxelTreeBranchingFactorsComrpessed = Shader.PropertyToID("voxelTreeBranchingFactorsCompressed");
    ...
    private static void RegisterCommonMeshingConstants(ComputeShader shader)
    {
      ...
      ComputeManager.RegisterConstantId(shader, Const.VoxelTreeBranchingFactorsComrpessed);
    ...
    public static bool ValidateComputeShaders()
    {
      ...
      // voxel gen
      {
        ...
        ComputeManager.RegisterConstantId(s_computeVoxelGen, Const.VoxelTreeBranchingFactorsComrpessed);
    ...
    private void BindComputeResources()
    {
      ...
      ComputeManager.SetInt(Const.VoxelTreeBranchingFactorsComrpessed, VoxelTreeBranchingFactorsComrpessed);
    ...
    private void BindRenderResources()
    {
      ...
      m_materialProps.SetInt(Const.VoxelTreeBranchingFactorsComrpessed, VoxelTreeBranchingFactorsComrpessed);
